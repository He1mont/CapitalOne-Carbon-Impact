...
describe('TransactionController', () => {
  it('should POST account/:id/transaction/create-random', async () => {
    ...
    const result = await app.httpRequest()
      .post(`/account/${mockAccountID}/transaction/create-random`)
      .expect(200);
  ...
  it('should GET account/:id/transaction/get-all', async () => {
    const mockId = 1;
    ...
    const result = await app.httpRequest()
      .get(`/account/${mockId}/transaction/get-all`)
      .expect(200);
  ...
  it('should GET /account/:accountID/transaction/:transactionID/get-by-id', async () => {
    ...
    const result = await app.httpRequest()
      .get(`/account/${mockAccountID}/transaction/${mockTransactionID}/get-by-id`)
      .expect(200);
