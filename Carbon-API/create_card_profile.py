...
# Check if account exists on hackathon API
...
if(response.status_code == 200): # If account exists
    ...
    # Check if a card profile has already been created
    ...
    if(response.status_code == 201): # If Card Profile creation is successful
